...
public class TCUploadHelper {
    ...
    public TCUploadHelper(Context context, OnUploadListener listener) {
        mContext = context;
        mListerner = listener;
    ...
    private void doUploadCover(final String path, String sig) {
        ...
        FileUploadTask task = new FileUploadTask(TCConstants.COS_BUCKET, path, netUrl, null, new IUploadTaskListener() {
            ...
            public void onUploadSucceed(final FileInfo result) {
                Log.d(TAG,"uploadCover do upload url:"+result.url);
