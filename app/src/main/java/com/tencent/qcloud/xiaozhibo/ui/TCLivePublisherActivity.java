...
/**
 * 推流模块Activity，所有的推流管理、消息管理、动画特效都在该类进行
 */
public class TCLivePublisherActivity extends TCBaseActivity implements ITXLivePushListener,
        View.OnClickListener, TCPusherMgr.PusherListener, BeautyDialogFragment.SeekBarCallback,
        TCInputTextMsgDialog.OnTextSendListener, TCChatRoomMgr.TCChatRoomListener,TXRtmpApi.IRtmpDataListener {
...
//    private SeekBar mBeautySeekBar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPushUrl = "http://live.qcloud.com/live/play.html?url=http%3A%2F%2F4968.liveplay.myqcloud.com%2Flive%2F4968_55555555777.flv&width=800&height=600";//intent.getStringExtra(TCConstants.PUBLISH_URL);
...
//                }
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        if (mAudioCtrl.getVisibility() != View.GONE && ev.getRawY() < mAudioCtrl.getTop()) {
            mAudioCtrl.setVisibility(View.GONE);
        }
