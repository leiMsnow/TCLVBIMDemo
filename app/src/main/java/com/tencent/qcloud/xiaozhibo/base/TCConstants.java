...
public class TCConstants {
	...
	*/
    //云通信服务相关配置
    public static final int IMSDK_ACCOUNT_TYPE = 8194;
    public static final int IMSDK_APPID = 1400017495;

    //COS存储服务相关配置
    public static final String COS_BUCKET = "wuxianzhibo";
    public static final String COS_APPID  = "1252817034";

    //业务Server的Http配置
    public static final String SVR_POST_URL = "http://10.255.209.97:7972/interface.php";
	...
	*/
    ...
    public static final int IMCMD_ENTER_LIVE = 2;   // 用户加入直播, Group消息  1
    public static final int IMCMD_EXIT_LIVE = 3;   // 用户退出直播, Group消息  2
    public static final int IMCMD_PRAISE = 4;   // 点赞消息, Demo中使用Group消息  3
